...
// Modern dark-accent color palette
var (
	colorNavBG   = theme.Color(theme.ColorNameBackground)
	colorCardBlue = theme.Color(theme.ColorNamePrimary)
	colorAccent  = theme.Color(theme.ColorNameForeground)
	colorSurface = theme.Color(theme.ColorNameCardBackground)
)
