...
func gradeColor(mark int) color.Color {
        switch {
        case mark == 10:
                return color.NRGBA{0, 166, 26, 255} // Ярко-зелёный
        case mark == 9:
                return color.NRGBA{26, 128, 26, 255} // Тёмно-зелёный
        case mark == 8:
                return theme.ForegroundColor() // По умолчанию
        case mark == 7:
                return color.NRGBA{128, 128, 128, 255} // Серый
        case mark >= 5:
                return color.NRGBA{217, 128, 0, 255} // Оранжевый
        case mark >= 1:
                return color.NRGBA{219, 38, 38, 255} // Красный
        default:
                return color.NRGBA{128, 0, 0, 255} // Тёмно-красный
        }
}
