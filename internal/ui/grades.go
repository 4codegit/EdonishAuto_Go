...
func gradeColor(mark int) color.Color {
        switch {
        case mark == 10:
                return color.NRGBA{R: 0, G: 166, B: 25, A: 255} // Ярко-зелёный
        case mark == 9:
                return color.NRGBA{R: 25, G: 128, B: 25, A: 255} // Тёмно-зелёный
        case mark == 8:
                return theme.ForegroundColor() // По умолчанию
        case mark == 7:
                return color.NRGBA{R: 128, G: 128, B: 128, A: 255} // Серый
        case mark >= 5:
                return color.NRGBA{R: 217, G: 128, B: 0, A: 255} // Оранжевый
        case mark >= 1:
                return color.NRGBA{R: 219, G: 38, B: 38, A: 255} // Красный
        default:
                return color.NRGBA{R: 128, G: 0, B: 0, A: 255} // Тёмно-красный
        }
}
...
func (g *GradesTab) rebuildTable() {
        ...
        for _, obj := range g.container_.Objects {
